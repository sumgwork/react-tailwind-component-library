...
const ReactTailwindComponentLibraryDS: React.FC<Props> = ({ children, theme: customTheme, dark, usePreferences = false }) => {
...
export default ReactTailwindComponentLibraryDS;
